...
This weight budget is zero-sum. Every kilogram you add to the vehicle is a kilogram you can't carry as freight. A diesel fuel tank for 400 litres of diesel weighs roughly 350 kg (the tank itself is relatively light; diesel is 0.84 kg/L). A battery pack storing the same *chemical* energy would weigh on the order of 16 tonnes at current lithium-ion energy densities. But that overstates the problem, because diesel engines waste most of that energy as heat. A diesel drivetrain converts roughly 40% of fuel energy to work at the wheels; an electric drivetrain converts roughly 90%. You don't need 16 tonnes of battery to match the *range* of a diesel tank — you need about 6–7 tonnes. That's still roughly 18 times heavier than the diesel tank and fuel it replaces, and it's still 6 tonnes of payload that disappears from every trip. Current battery electric trucks achieve 150–300 miles of range with this kind of penalty. The [energy density section below](#why-diesel) works through the full arithmetic.
...
UK speed limits for heavy vehicles are also more complex than most car drivers realise. Articulated trucks over 7.5 tonnes in England and Wales: 40 mph on single carriageways, 50 mph on dual carriageways, 60 mph on motorways (though the 56 mph limiter caps actual speed below the motorway limit). These vary by vehicle class, road type, and whether the vehicle is rigid or articulated. The lorry pulling out on the A-road at what feels like 40 mph isn't being lazy. They might be doing the legal maximum.
...
One thing worth noting: what sounds like an idling truck at a rest stop may actually be a trailer refrigeration unit (TRU) running on its own small diesel engine, keeping a cold-chain load at temperature. That's not optional and it's not the main engine.
