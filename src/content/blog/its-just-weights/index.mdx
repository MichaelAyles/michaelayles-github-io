...
Last month, Cortical Labs published a demo of their CL1 system: 200,000 human brain cells, grown on a multielectrode array, playing a simplified version of DOOM. The reception on Hacker News was dominated by dread, not curiosity. The top comment and discussion found it 'creepy', there were comments like "I Have No Mouth and I Must Scream." Others debated whether Cortical Labs had built the Torment Nexus. To paraphrase one commenter: we grew a brain on a petri dish, gave it a shotgun, and sent it to hell.

I thought it was bloody cool. I also think the panic is completely unwarranted. Here's why.
