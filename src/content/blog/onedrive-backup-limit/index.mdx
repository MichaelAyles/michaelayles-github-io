...
OneDrive has huge, blind hole if you're using it in/as your backup strategy. It silently fails if you have too many files. 
...
Thankfully, in this case, OneDrive isn't my only backup, it's just one layer in my strategy. I run a NAS as my primary, running RAID 1 so one dead disk takes nothing with it, replicated to a second location so a fire or a burglary does not either. That is the actual safety net and it was never at risk.
