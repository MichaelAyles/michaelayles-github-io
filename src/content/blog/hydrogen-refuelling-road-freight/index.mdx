...
The [previous post](/blog/on-vehicle-hydrogen-generation) dealt with on-vehicle hydrogen generation: splitting water with the truck's own alternator and feeding the hydrogen back into the engine. That's a thermodynamic impossibility. The energy chain is a closed loop that loses at every step.
...
2. Electrolysis: electricity to hydrogen. ~66% efficient.
3. Compression to 700 bar or liquefaction to -253°C. ~85-90% efficient.
4. Transport and dispensing. ~95% efficient.
5. Fuel cell: hydrogen to electricity. ~55-60% efficient.
6. Electric motor to wheel. ~90% efficient.

Multiply those together: roughly **25-27%** of the original renewable electricity reaches the wheels.
...
*This post is part of a series on fleet fuel economy and freight decarbonisation. The [first post](/blog/heavy-haulage-basics) covers the physics and economics foundations. Previous: [on-vehicle hydrogen generation](/blog/on-vehicle-hydrogen-generation). Next: evaluating fuel economy claims [coming soon].*
