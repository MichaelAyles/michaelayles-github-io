...
| Step | tok/s | The idea |
|---|---|---|
| A53 char chat | 11 | the CPU baseline |
| HW sequencer @40 MHz | 44 | take the CPU out of the loop entirely |
| wide P-lane datapath | 1,883 | one URAM word feeds 128+ lanes |
| N=8 single-pass | 19,276 | one weight pass serves 8 streams |
| split-brain N=14 | 36,971 | two 7-stream cohorts on the dual-port URAM |
| **N=16 split-brain @ 200 MHz** | **59,965.5** | **the record (two cohorts of 8)** |
