...
|---|---|---|---|
| CO2 | 1 (reference gas) | 1 (reference gas) | Centuries (40% remains after 100 years) |
| CH4 (methane, fossil) | 29.8 | 82.5 | ~12 years |
| N2O (nitrous oxide) | 273 | 273 | ~116 years |

CO2's GWP of 1 is a convention, not a statement about severity. It's the yardstick everything else is measured against. The "1" represents the warming from a kilogram of CO2 integrated over the chosen timescale — a century's worth of heat trapping. CO2 dominates total warming because there's so much of it, and because it persists: 40% of a CO2 pulse is still in the atmosphere after 100 years. The multiplier framework is useful for comparing gases per kilogram, but it can mislead if you read "1" as "unimportant."
