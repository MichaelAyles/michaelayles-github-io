...
import AddingVsRecycling from '@/components/blog/AddingVsRecycling';
...
Before getting into the numbers, it's worth understanding why this is fundamentally different from technologies that do work.

A diesel-LPG dual-fuel system injects liquefied petroleum gas alongside diesel. LPG is an external fuel with its own chemical energy content — about 46 MJ/kg. The system takes 100 units of energy from diesel and adds 20 more from LPG. Total energy input goes up. If LPG is cheaper than diesel per unit of energy, you save money. The physics works because you're adding energy from a second source.
...
<AddingVsRecycling client:visible />
